      ...
      <DetailPart>
        <OtherPart>
          ...
          <p>
            ...
            {Math.round(location.state.totalNutrients.CHOCDF.quantity)}
            {location.state.totalNutrients.CHOCDF.unit}
          </p>
          <p>
            {location.state.totalNutrients.CHOLE.label} :{" "}
            {Math.round(location.state.totalNutrients.CHOLE.quantity)}
            {location.state.totalNutrients.CHOLE.unit}
          </p>
          <p>
            {location.state.totalNutrients.ENERC_KCAL.label} :{" "}
            {Math.round(location.state.totalNutrients.ENERC_KCAL.quantity)}
